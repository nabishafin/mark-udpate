    ...
    <section id="systems" className="hpe-section relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <motion.div
          ...
          <div className="hpe-hud-label mb-3">05 · Systems</div>
          <h2 className="text-3xl sm:text-5xl font-medium text-white tracking-tight leading-[1.05]">
            ...
            <span className="hpe-text-chrome">measurably elevated.</span>
          </h2>
          <p className="mt-5 text-white/60 text-base sm:text-lg leading-relaxed">
            Click any system below to inspect its biological pathway, hydration
            response, and recovery profile — or return to the body diagram to
            explore in context.
          </p>
        </motion.div>
            ...
            return (
              <motion.button
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 text-white/55 text-sm leading-snug line-clamp-2">
                    {organ.tagline}
                  </p>
